...
* [Reactive HTTP Client](https://docs.spring.io/spring-boot/4.1.0-SNAPSHOT/reference/io/rest-client.html#io.rest-client.webclient)
* [Spring Web](https://docs.spring.io/spring-boot/4.1.0-SNAPSHOT/reference/web/servlet.html)
* [Neo4j](https://docs.spring.io/spring-boot/4.1.0-SNAPSHOT/reference/data/nosql.html#data.nosql.neo4j)
